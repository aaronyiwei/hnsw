...
int main() {
    ...
    double t0 = elapsed();
    {
        ...
        // xq = fvecs_read("/Users/aaron/Downloads/siftsmall/siftsmall_query.fvecs",
        // &d2, &nq);
    }
    ...
    int *gt;       // nq * k matrix of ground-truth nearest-neighbors
    {
        ...
        // gt =
        // ivecs_read("/Users/aaron/Downloads/siftsmall/siftsmall_groundtruth.ivecs",
        // &k, &nq2);
    ...
    { // Use the found configuration to perform a search
        ...
        for (int i = 0; i < nq; i++) {
            ...
            // std::vector<int> knns = my_hnswgraph.KNNSearch(xq + i * d2, 100, mean,
            // query_mean);
